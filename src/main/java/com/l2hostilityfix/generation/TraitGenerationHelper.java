package com.l2hostilityfix.generation;

import com.l2hostilityfix.config.L2HConfig;
import com.l2hostilityfix.config.L2HConfig.ExclusionGroup;
...
public class TraitGenerationHelper {
    ...
    private static void discoverFields() {
        if (ENTITY_FIELD != null && TRAITS_FIELD != null && MOB_LEVEL_FIELD != null && LEVEL_FIELD != null && INS_FIELD != null) return;
